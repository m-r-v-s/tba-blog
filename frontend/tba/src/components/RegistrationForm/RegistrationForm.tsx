...
import {FormState} from "../../app/views/UserRegistration";
            ...
            return <>
                <fieldset>
                    ...
                    <div className="register-field">
                        ...
                        <input id="password" type="text" name="password" value={formState.user_input.password}
                               className="register-input_text"
                               onChange={(e: React.ChangeEvent<HTMLInputElement>) => formState.set_form(formState, e)}/>
                    </div>
        ...
        case "REGISTER_DETAILS":
            return <>
                <div className="register-form">
                    <form>
                        <label className="register-label"> About yourself </label>
                        <input type="text" name="firstname" placeholder="Your first name..."
                               className="register-input_text"/>
                        <input type="text" id="lastname" placeholder="Your last name..."
                               className="register-input_text"/>
                        <input type="email" placeholder="Your email..." className="register-input_text"/>
                        <select name="country" id="country" className="country" defaultValue="United States"
